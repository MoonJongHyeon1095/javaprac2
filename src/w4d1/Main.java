...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("원 지름: " + circle.지름계산());
        System.out.println("원 둘레: " + circle.둘레계산());
        System.out.println("원 면적: " + circle.면적계산());
        ...
        System.out.println("직사각형 대각선 길이: " + rectangle.대각선계산());
        System.out.println("직사각형 면적: " + rectangle.면적계산());
        System.out.println("직사각형 둘레길이: " + rectangle.둘레계산());
